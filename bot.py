availabilityDomains = ["XPaD:AP-SINGAPORE-1-AD-1"]
displayName = '	4-24'
compartmentId = 'ocid1.tenancy.oc1..aaaaaaaaxtksrop6b2w5gnsndcgophfnt6zqew5v62op3erk5fyx3e2us2ka'
subnetId = 'ocid1.subnet.oc1.ap-singapore-1.aaaaaaaajakevzzl7d3y7xld7yqgczx4srpixfklmz64jyg6o2hbjl5cly4a'
...
imageId = "ocid1.image.oc1.ap-singapore-1.aaaaaaaak32wjeogo4vzf6fkv4kdvharg3ht456ukfhjdqkjsdrbbzzlfveq"
...
while True:
	for availabilityDomain in availabilityDomains:
		...
		try:
			...
			message = 'VPS is created successfully for tmixbeats@gmail.com! Watch video to get public ip address for your VPS'
			logging.info(message)
